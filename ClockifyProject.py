class ClockifyProject():
    def __init__(self, incoming_project):        
        ...
        self.workspaceId = incoming_project['workspaceId']
        self.archived = incoming_project['archived']        
        self.clientId = incoming_project['clientId']
...
# 'note': '', 
# 'costRate': None, 
# 'timeEstimate': {'estimate': 'PT0S', 'type': 'AUTO', 'resetOption': None, 'active': False, 'includeNonBillable': True}, 
